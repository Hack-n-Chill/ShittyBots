...
def detect_it(CAM_ID,CAM_IP,STREAM_PORT):
        ...
        subprocess.Popen("xterm -e 'tty >&3; cd /home/roybiparnak/Work/moxa/hacknchill/ShittyBots/darknet_detection && ./darknet detector demo data/obj.data yolo-obj-test.cfg backup/yolo-obj_best.weights {0}  -cam_id {1} -interval 2' 3>&1".format(CAM_IP, CAM_ID),shell=True, stdout=subprocess.PIPE)
